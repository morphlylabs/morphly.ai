  ...
  return (
    <section className="note-prose relative w-full py-16 md:py-32">
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="bg-primary/5 absolute -bottom-[10%] -right-[10%] h-[40%] w-[40%] rounded-full blur-3xl" />
      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="mx-auto max-w-2xl space-y-6 text-center">
          ...
          <p>
            ...
            platform brings your imagination to life with parametric precision.
          </p>
        </div>
